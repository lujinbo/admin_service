...
class AbstractChannel
{
    ...
    {
        if ($this->debug) {
            MiscHelper::debug_msg('waiting for a Novice frame');
        }
    ...
    public function wait_content()
    {
        ...
        // $payload_reader = Novice AMQPReader(substr($payload,0,12));
        ...
        //hack to avoid creating Novice instances of AMQPReader;
    ...
    public function wait($allowed_methods = null, $non_blocking = false, $timeout = 0)
    {
        ...
        // No deferred methods?  wait for Novice ones
        while (true) {
